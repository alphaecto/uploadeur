...
if(type) // Fichier
	var filename = prompt("Indiquez le nom du nouveau fichier texte à créer : ","Nouveau Fichier.txt");
else // Dossier
	var filename = prompt("Indiquez le nom du nouveau dossier à créer : ","Nouveau Dossier");
...
var newname = (type) ? prompt("Nouveau nom du fichier \""+filename+"\" ?",filename) : prompt("Nouveau nom du dossier \""+filename+"\" ?",filename);
...
var confirms = (type) ? confirm("Voulez vous vraiment supprimer le fichier \""+filename+"\" ?") : confirm("Voulez vous vraiment supprimer le dossier \""+filename+"\" ?");
if(confirms)
...
// Suppression de la sélection			
	function delete4select() {
		var ask = (count == 1) ? "Voulez vous vraiment supprimer cet élément ?" : "Voulez vous vraiment supprimer les "+count+" éléments sélectionnés ?";
		if(count == 0)
...
if(bool = prompt("Indiquez le nom de l\'archive ZIP à créer: ","Nouvelle Archive.zip"))
	{
	More.value = "Compression...";
...
if(confirm("Voulez vous vraiment extraire les fichiers de l'archive \""+basename(fp)+"\" sur ce dossier ?"))
	{
	More.value = "Décompression...";
